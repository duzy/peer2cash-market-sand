...
struct MainSignalsInstance {
    ...
    boost::signals2::signal<void (const CTransaction &)> TransactionChanged;
...
void RegisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    g_signals.m_internals->TransactionChanged.connect(boost::bind(&CValidationInterface::TransactionChanged, pwalletIn, _1));
...
void UnregisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    g_signals.m_internals->TransactionChanged.disconnect(boost::bind(&CValidationInterface::TransactionChanged, pwalletIn, _1));
...
void UnregisterAllValidationInterfaces() {
    ...
    g_signals.m_internals->TransactionChanged.disconnect_all_slots();
...
void CMainSignals::TransactionChanged(const CTransaction &tx) {
    m_internals->TransactionChanged(tx);
}
