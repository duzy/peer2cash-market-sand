...
public:
    CMainParams() {
        ...
        consensus.BIP34Height = 0;          // TODO: BIP34?
        consensus.BIP34Hash = uint256S(""); // TODO: BIP34?
        consensus.BIP65Height = 0;          // TODO: BIP65?
        consensus.BIP66Height = 0;          // TODO: BIP66?
...
#if 0 // FIXME: Enable consensus BIP?.
      // TODO: Refine consensus base on related BIPs.
        ...
        // 0x000000000000000000000000000000000000000000723d3581fe1bd55373540a
        consensus.nMinimumChainWork = uint256S("0x00");

        // By default assume that the signatures in ancestors of this block are valid.
        // 0x0000000000000000003b9ce759c2a087d52abc4266f8f4ebd6d768b89defa50a (477890)
         ...
         */
        pchMessageStart[0] = 0xf9 ^ 0x62;
        pchMessageStart[1] = 0xbe ^ 0x69;
        pchMessageStart[2] = 0xb4 ^ 0x74;
        pchMessageStart[3] = 0xd9 ^ 0x79;
        nDefaultPort = 1333;
        ...
        // Using addresses fully compatible with Bitcoin Core.
...
public:
    CTestNetParams() {
      ...
      // TODO: Refine consensus base on related BIPs.
        ...
        pchMessageStart[0] = 0x0b ^ 0x62;
        pchMessageStart[1] = 0x11 ^ 0x69;
        pchMessageStart[2] = 0x09 ^ 0x74;
        pchMessageStart[3] = 0x07 ^ 0x79;
        nDefaultPort = 1334;
        ...
        checkpointData = CCheckpointData{
            {
                { 0, uint256S("0x000458ce9dda124cbf0158dab7996e2071d6b90fcc2486b622947382ff45ae80") },
            }
        };
...
public:
    CRegTestParams() {
        ...
        pchMessageStart[0] = 0xfa ^ 0x62;
        pchMessageStart[1] = 0xbf ^ 0x69;
        pchMessageStart[2] = 0xb5 ^ 0x74;
        pchMessageStart[3] = 0xda ^ 0x79;
        nDefaultPort = 1335;
        nPruneAfterHeight = 1000;
